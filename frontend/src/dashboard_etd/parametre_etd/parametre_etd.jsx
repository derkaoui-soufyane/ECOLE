...
══════════════════════════════════════ */
export default function Parametre_etd({ dataetd = [] }) {
  const profData = dataetd[0] || {};
          ...
          <div className="param-profile-card">
            <div className="param-profile-card__top">
              ...
              <div>
                ...
                <p className="param-profile-email">{profData.email || "—"}</p>
              </div>
            </div>
            <div className="param-profile-card__body">
              ...
              <div className="param-profile-row">
                <span className="param-profile-row__key">classe</span>
